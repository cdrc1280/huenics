...
class AuditLog extends Model
{
    ...
    public static function logActivity(
        ...
        try {
            ...
            try {
                ...
                Log::warning('AuditLog creation failed: '.$ex->getMessage());
    ...
    public function getSubjectIdentifierAttribute(): string
    {
        ...
        if ($this->auditable) {
            $r = $this->auditable;
            if (isset($r->quotation_number)) {
                return "#{$r->quotation_number}";
            }
            if (isset($r->po_number)) {
                return "#{$r->po_number}";
            }
            if (isset($r->dr_number)) {
                return "#{$r->dr_number}";
            }
            if (isset($r->invoice_number)) {
                return "#{$r->invoice_number}";
            }
            if (isset($r->document_number)) {
